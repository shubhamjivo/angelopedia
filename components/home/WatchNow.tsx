  ...
  return (
    <section className="screen-section flex h-svh flex-col overflow-hidden bg-neutral-900 text-white">
      <Container className="flex min-h-0 flex-1 flex-col py-5 lg:py-8">
        ...
        >
          <Link href={tab.featured.href} className="group order-1 block h-full min-h-0">
          ...
          <Link href={tab.featured.href} className="group order-2 lg:order-3">
          ...
          >
            {tab.items.map((item) => (
              <li key={item.title} className="min-h-0">
                ...
                >
                  <div className="relative aspect-[5/6] h-full max-h-full w-auto shrink-0">
                    <CoverImage
                      src={item.image}
                      alt={item.title}
                      className="h-full w-full"
